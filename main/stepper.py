...
class Stepper_Motor:
	...
	__STM_IP = '192.168.0.80' # This must be configured via dial on front
	...
	def get_pos(self) -> int:
		pos_cmd = "SP"
		pos = self.__send(pos_cmd)
		return pos

	def move_abs(self, pos: int) -> None:
		"""Move to an absolute coordinate"""
		abs_move_com = "FP{}".format(pos)
		self.__send(abs_move_com)
		time.sleep(0.5) # sleep for 500 microseconds
		self. __wait_for_move()
		return None
